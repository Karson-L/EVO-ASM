...
\bibitem{zhangwei2008}
张维, 熊熊, 等. (2008). 基于Agent的计算金融学：原理、方法与展望. \textit{管理科学学报}, 11(6), 1--20.

\bibitem{xiong2010}
熊熊, 张维, 等. (2010). 计算实验金融：方法论与研究框架. \textit{系统工程理论与实践}, 30(9), 1537--1548.

\bibitem{zhangwei2012}
张维, 李根, 熊熊, 等. (2012). 资产价格泡沫研究进展：基于计算实验金融的视角. \textit{管理评论}, 24(6), 3--14.

% [!] 中文文献的卷期页码请用户在知网核实后修正。
\end{thebibliography}

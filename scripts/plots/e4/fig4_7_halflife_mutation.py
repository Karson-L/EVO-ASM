"""Fig 4.7: Alpha half-life by mutation.
Usage: python fig4_7.py --data-dir <path>
"""
import sys, argparse
...
def main(data_dir=None, output_dir=None):
    ...
    if "alpha" in fam.columns:
        ax.hist(fam["alpha"].dropna(), bins=30, color="#31A354", alpha=0.7, edgecolor="white")
        ax.set_xlabel("Alpha")
    ax.set_title("Figure 4.7: Alpha Distribution with Mutation")
    fig.savefig(output_dir/"fig4_7_halflife_mutation.png");plt.close(fig)
    print("Saved Fig 4.7")
